...
# from data.extract_medical_vocab import where_to_mask
...
class VLCXRDataset(Dataset):
    def __init__(self, data_path, tokenizer, transforms, args):
        ...
        if args.tokenizer == "microsoft/BiomedVLP-CXR-BERT-specialized": 
            ...
            self.vocab_stoi = tokenizer.vocab
    ...
    def __getitem__(self, idx):
        ...
        origin_txt, img_path, is_aligned, itm_prob = self.unpack_data(idx)
